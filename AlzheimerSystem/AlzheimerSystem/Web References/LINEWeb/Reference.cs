...
namespace AlzheimerSystem.LINEWeb {
    using System;
    ...
    public partial class ADweb : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback SaveLineTokenOperationCompleted;
        ...
        /// <remarks/>
        public ADweb() {
            this.Url = global::AlzheimerSystem.Properties.Settings.Default.AlzheimerSystem_LINEWeb_ADweb;
        ...
        /// <remarks/>
        public event SaveLineTokenCompletedEventHandler SaveLineTokenCompleted;
        ...
        public string GetIndoorCurrentDate() {
            object[] results = this.Invoke("GetIndoorCurrentDate", new object[0]);
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void GetIndoorCurrentDateAsync() {
            this.GetIndoorCurrentDateAsync(null);
        }
        
        /// <remarks/>
        public void GetIndoorCurrentDateAsync(object userState) {
            ...
            this.InvokeAsync("GetIndoorCurrentDate", new object[0], this.GetIndoorCurrentDateOperationCompleted, userState);
        }
        ...
        public System.Data.DataSet GetIndoorCurrent() {
            object[] results = this.Invoke("GetIndoorCurrent", new object[0]);
            return ((System.Data.DataSet)(results[0]));
        }
        
        /// <remarks/>
        public void GetIndoorCurrentAsync() {
            this.GetIndoorCurrentAsync(null);
        }
        
        /// <remarks/>
        public void GetIndoorCurrentAsync(object userState) {
            ...
            this.InvokeAsync("GetIndoorCurrent", new object[0], this.GetIndoorCurrentOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/SaveLineToken", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public int SaveLineToken(string userCode, string 帳號) {
            object[] results = this.Invoke("SaveLineToken", new object[] {
                        userCode,
                        帳號});
            return ((int)(results[0]));
        }
        ...
        /// <remarks/>
        public void SaveLineTokenAsync(string userCode, string 帳號) {
            this.SaveLineTokenAsync(userCode, 帳號, null);
        }
        
        /// <remarks/>
        public void SaveLineTokenAsync(string userCode, string 帳號, object userState) {
            if ((this.SaveLineTokenOperationCompleted == null)) {
                this.SaveLineTokenOperationCompleted = new System.Threading.SendOrPostCallback(this.OnSaveLineTokenOperationCompleted);
            }
            this.InvokeAsync("SaveLineToken", new object[] {
                        userCode,
                        帳號}, this.SaveLineTokenOperationCompleted, userState);
        }
        
        private void OnSaveLineTokenOperationCompleted(object arg) {
            if ((this.SaveLineTokenCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.SaveLineTokenCompleted(this, new SaveLineTokenCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    public delegate void SaveLineTokenCompletedEventHandler(object sender, SaveLineTokenCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class SaveLineTokenCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal SaveLineTokenCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
